...
HD_PWD='D:/Digital course/assignment/Session 4/main assignment/Q2/Vivado/Vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Simple_DSP1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Simple_DSP1.tcl
