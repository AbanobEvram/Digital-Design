...
HD_PWD='D:/Digital course/assignment/Session 4/main assignment/Q2/Vivado/Vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Simple_DSP1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Simple_DSP1.tcl -notrace
